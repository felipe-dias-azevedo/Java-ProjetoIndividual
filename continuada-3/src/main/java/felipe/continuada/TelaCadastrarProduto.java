...
public class TelaCadastrarProduto extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String precoString = jTextField2.getText();
        String categoriaString = jTextField3.getText();
        Double preco = Double.valueOf(precoString);
        Integer categoria = Integer.valueOf(categoriaString);
        
        Connection.InsertProduto(nome, preco, categoria);
        
        JOptionPane.showMessageDialog(null, "Produto Cadastrado com Sucesso!", null, WIDTH);
